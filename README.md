...
- `PUBLIC_BASE_URL` or `DASHBOARD_BASE_URL`
- `DISCORD_REDIRECT_URI`
- `SESSION_SECRET` or `DASHBOARD_SECRET_KEY`
...
- `DISCORD_BOT_PERMISSIONS` or `DISCORD_INSTALL_PERMISSIONS`
...
- `RAILWAY_PUBLIC_DOMAIN` is used automatically if you do not set `PUBLIC_BASE_URL` or `DASHBOARD_BASE_URL`.
- If your Railway variables use dashboard-style names, this app accepts them too:
  `DISCORD_APP_ID`, `DASHBOARD_BASE_URL`, `DASHBOARD_SECRET_KEY`, and `DISCORD_INSTALL_PERMISSIONS`.
